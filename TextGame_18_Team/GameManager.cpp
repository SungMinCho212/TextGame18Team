...
#include "AssasinW.h"
#include "AssasinW.cpp"
#include "WarriorW.h"
#include "WarriorW.cpp"
#include "MageW.h"
#include "MageW.cpp"
...
void GameManager::VisitShop() 
{
    while (true) 
    {
        ...
        cout << "3) 워리어전용무기(STR+50) 50Gold\n";
        cout << "4) 메이지전용무기(INTL+50) 50Gold\n";
        cout << "5) 어썌신전용무기(AGI+50) 50Gold\n";
        cout << "선택: ";
        int c; cin >> c;
        if (c == 0) break;
        ...
        else if (c == 3) { toBuy = new AssasinW(1); price = 50; }
        else if (c == 4) { toBuy = new AssasinW(1); price = 50; }
        else if (c == 5) { toBuy = new AssasinW(1); price = 50; }
